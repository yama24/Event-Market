						...
						<div class="card">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="event_name" name="event_name" placeholder="Event Name" value="<?= set_value('event_name'); ?>">
								...
								<div class="form-group">
									...
									<div class="row">
										<div class="col">
											<input type="date" class="form-control" id="event_date" name="event_date" value="<?= set_value('event_date'); ?>">
											<?= form_error('event_time', '<small class="text-danger pl-3">', '</small>'); ?>
										</div>
										<div class="col">
											<input type="time" class="form-control" id="event_time" name="event_time" value="<?= set_value('event_time'); ?>">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="event_description" id="event_description"><?= set_value('event_description'); ?></textarea>
							...
							<div class="card-body">
								...
								<div class="form-group">
									<div class="custom-file">
										...
										<label class="custom-file-label text-truncate" for="event_image">Choose file</label>
								...
								<div class="row">
									<div class="col-lg-6">
										<img id="image-preview" alt="image-preview" class="img-fluid mb-3" style="display: none;">
									</div>
								</div>
								<div class="form-group">
									<div class="form-check">
										<input class="form-check-input" type="checkbox" value="1" id="event_status" name="event_status">
								...
								<div class="form-group" id="price" style="display: none;">
									...
									<input type="text" class="form-control" id="event_price" name="event_price" placeholder="Event Price" value="<?= set_value('event_price'); ?>">
